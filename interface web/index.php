...
try {
    ...
    if (isset($_POST['script'])) {
        if ($_POST['script'] == 'fileConfig') {//bloc 1 : enregistrement des entrees
            ...
            $_SESSION['file']['video']['frames']    = isset($_POST['frames'])   ? filter_input(INPUT_POST, 'frames',    FILTER_VALIDATE_FLOAT)  : false ;
            $_SESSION['file']['video']['move']['x'] = isset($_POST['moveX'])    ? filter_input(INPUT_POST, 'moveX',     FILTER_VALIDATE_FLOAT)  : false ;
            $_SESSION['file']['video']['move']['y'] = isset($_POST['moveY'])    ? filter_input(INPUT_POST, 'moveY',     FILTER_VALIDATE_FLOAT)  : false ;
            $_SESSION['file']['video']['move']['z'] = isset($_POST['moveZ'])    ? filter_input(INPUT_POST, 'moveZ',     FILTER_VALIDATE_FLOAT)  : false ;
            ...
            $_SESSION['scene']['viewer']['x']           = isset($_POST['viewerX'])      ? filter_input(INPUT_POST, 'viewerX',       FILTER_VALIDATE_FLOAT)  : false ;
            $_SESSION['scene']['viewer']['y']           = isset($_POST['viewerY'])      ? filter_input(INPUT_POST, 'viewerY',       FILTER_VALIDATE_FLOAT)  : false ;
            $_SESSION['scene']['viewer']['z']           = isset($_POST['viewerZ'])      ? filter_input(INPUT_POST, 'viewerZ',       FILTER_VALIDATE_FLOAT)  : false ;
            ...
            for ($light = 0; $light < $nbLight; $light++) {
                ...
                $_SESSION['scene']['light'][$light]['pos']['x'] = isset($_POST['lightX'])   ? filter_input(INPUT_POST, 'lightX', FILTER_VALIDATE_FLOAT) : false ;
                $_SESSION['scene']['light'][$light]['pos']['y'] = isset($_POST['lightY'])   ? filter_input(INPUT_POST, 'lightY', FILTER_VALIDATE_FLOAT) : false ;
                $_SESSION['scene']['light'][$light]['pos']['z'] = isset($_POST['lightZ'])   ? filter_input(INPUT_POST, 'lightZ', FILTER_VALIDATE_FLOAT) : false ;
        ...
        if ($_POST['script'] == 'sceneConfig') {//bloc 2 : enregistrement des entrees
            ...
            for ($elli = 1; $elli <= $nbElli; $elli++) {
                ...
                $_SESSION['ellipsoid'][$elli]['pos']['x']   = isset($_POST['elli'.$elli.'_xPos'])   ? filter_input(INPUT_POST, 'elli'.$elli.'_xPos', FILTER_VALIDATE_FLOAT)   : false ;
                $_SESSION['ellipsoid'][$elli]['pos']['y']   = isset($_POST['elli'.$elli.'_yPos'])   ? filter_input(INPUT_POST, 'elli'.$elli.'_yPos', FILTER_VALIDATE_FLOAT)   : false ;
                $_SESSION['ellipsoid'][$elli]['pos']['z']   = isset($_POST['elli'.$elli.'_zPos'])   ? filter_input(INPUT_POST, 'elli'.$elli.'_zPos', FILTER_VALIDATE_FLOAT)   : false ;
                $_SESSION['ellipsoid'][$elli]['rad']['x']   = isset($_POST['elli'.$elli.'_xRad'])   ? filter_input(INPUT_POST, 'elli'.$elli.'_xRad', FILTER_VALIDATE_FLOAT)   : false ;
                $_SESSION['ellipsoid'][$elli]['rad']['y']   = isset($_POST['elli'.$elli.'_yRad'])   ? filter_input(INPUT_POST, 'elli'.$elli.'_yRad', FILTER_VALIDATE_FLOAT)   : false ;
                $_SESSION['ellipsoid'][$elli]['rad']['z']   = isset($_POST['elli'.$elli.'_zRad'])   ? filter_input(INPUT_POST, 'elli'.$elli.'_zRad', FILTER_VALIDATE_FLOAT)   : false ;
            ...
            for ($poly = 1; $poly <= $nbPoly; $poly++) {
                ...
                for ($face = 1; $face <= $nbFace; $face++) {
                    ...
                    for ($peak = 1; $peak <= $nbPeak; $peak++) {
                        $_SESSION['polyhedron'][$poly][$face]['peak'][$peak]['x']   = isset($_POST['poly'.$poly.'_face'.$face.'_peak'.$peak.'_xPos'])   ? filter_input(INPUT_POST, 'poly'.$poly.'_face'.$face.'_peak'.$peak.'_xPos', FILTER_VALIDATE_FLOAT)   : false ;
                        $_SESSION['polyhedron'][$poly][$face]['peak'][$peak]['y']   = isset($_POST['poly'.$poly.'_face'.$face.'_peak'.$peak.'_yPos'])   ? filter_input(INPUT_POST, 'poly'.$poly.'_face'.$face.'_peak'.$peak.'_yPos', FILTER_VALIDATE_FLOAT)   : false ;
                        $_SESSION['polyhedron'][$poly][$face]['peak'][$peak]['z']   = isset($_POST['poly'.$poly.'_face'.$face.'_peak'.$peak.'_zPos'])   ? filter_input(INPUT_POST, 'poly'.$poly.'_face'.$face.'_peak'.$peak.'_zPos', FILTER_VALIDATE_FLOAT)   : false ;
