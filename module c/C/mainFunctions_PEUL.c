...
int doesRayCollideWithAnySphere(sParam param, sParamEqua paramEqua) {// le but est de renvoyer 1 si l'eq paramétrique touche une sphère avec t > 0 et t < 1
...
int doesRayCollideWithAnyEllipse(sParam param, sParamEqua paramEqua) {
